 ...
 * Modified by Jan Lorenz Soliman 8/7/2009
 */
...
public class DateSelector extends AbstractField
{
	...
	void beginRender(MarkupWriter writer)
	{
		...
		{																	 
            if (month == -1) {
			org.apache.tapestry5.dom.Element element = writer.element("option",  "value", "Month");
		...
		{
            if (year == firstYear-1) {
                org.apache.tapestry5.dom.Element element = writer.element("option","value", "Year");
