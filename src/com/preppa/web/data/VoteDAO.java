...
public interface VoteDAO extends GenericDAO<Vote, Long> {
    ...
    List<Long> findIdByContentTypeApproved(ContentType contentType, Integer threshold);

    List<Long> findIdByContentTypeAwaiting(ContentType contentType, Integer threshold);
}
